...
export default function DestinationClientPage({ item, relatedDestinations }: DestinationClientPageProps) {
    return (
                    ...
                    >
                        ...
                        <div className="prose prose-lg max-w-none text-gray-600 font-open-sans">
                            ...
                            {item.gallery && item.gallery.length > 0 && (
                             ...
                             {item.contentHtml2 && (
                                <div className="prose pt-10 prose-lg max-w-none text-gray-600 font-open-sans">
                                    <div dangerouslySetInnerHTML={{ __html: item.contentHtml2 }} />
                                </div>
                            )}
                            ...
                            <div className="mt-12 pt-8 border-t border-gray-100 flex flex-wrap gap-4 not-prose">
                                <a
                                    href={`https://wa.me/254740726783?text=Hello%2C%20I%20would%20like%20to%20inquire%20about%20${encodeURIComponent(item.name)}.`}
                                    target="_blank"
