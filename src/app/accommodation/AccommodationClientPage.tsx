...
interface AccommodationClientPageProps {
  heading: string;
  description: string;
  items: {
    title: string;
...
export default function AccommodationClientPage({ heading, description, items, moreItems }: AccommodationClientPageProps) {
  return (
