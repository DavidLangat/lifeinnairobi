          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 justify-start">
            ...
            <div className="lg:col-span-8 space-y-1">
              ...
              >
                ...
                {details.contentHtmltop && (
                  <>
                    <div className="lg:hidden">
                      <HTMLContentFirstParagraph contentHtml={details.contentHtmltop} />
                      {/* Mobile Booking & Pricing Cards */}
                      <ActivityPricingCard details={details} className="lg:hidden mb-6" />
                      <ActivityBookingCard activity={activity} details={details} className="lg:hidden mb-10">
                    ...
                    <div
                      ...
                      dangerouslySetInnerHTML={{ __html: details.contentHtmltop }}
                    />
                  </>
                )}
                ...
                {details.gallery && details.gallery.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-auto md:h-[400px] not-prose">
                    {details.gallery.slice(0, 2).map((img: any, idx: number) => (
                  ...
                  <div className="relative rounded-xl overflow-hidden h-[400px] w-full not-prose">
                    <Image
                       src={activity.image} alt={activity.name} fill className="object-cover" />
                  </div>
                )}
              ...
              >
                ...
                {details.contentHtml ? (
                  ...
                  <div className="prose prose-lg max-w-none text-gray-600">{details.fullDescription}</div>
                )}
                ...
                {!details.contentHtml && details.highlights && (
                  <div className="bg-gray-50 p-6 rounded-xl not-prose">
                    <h3 className="font-serif text-xl font-medium mb-4">Highlights</h3>
            ...
            <div className="lg:col-span-4 relative">
              ...
              >
                ...
                <ActivityPricingCard details={details} className="hidden lg:block" />
                <ActivityBookingCard activity={activity} details={details} className="hidden lg:block">
                  <ActivityBookingWidget 
                    activitySlug={activity.slug || details.slug || ''} 
                    activityName={activity.name}
                    basePrice={activity.price || 0}
