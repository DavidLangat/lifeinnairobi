...
export default function CancelPolicyPage() {
  ...
  const heroImage =
    "https://ik.imagekit.io/kggumm8iz/Nairobilife/v2/images/Ridge%20Cabin%20Resort.jpg";
  ...
  return (
    <main className="min-h-screen bg-primary">
      ...
      <div className="relative z-10">
        ...
        <BlogPostHero image={""} title={title} alt={title} />
      </div>
      ...
      <article className=" pb-20">
        ...
        <div className="container mx-auto px-6 lg:px-12 max-w-5xl">
          ...
          <div className="prose prose-lg max-w-none text-gray-600 font-open-sans">
            <p>
              We understand that plans can sometimes change, and we aim to be as
              fair and flexible as possible while ensuring smooth planning for
              all experiences.
            </p>

            <p>
              Cancellations made more than 48 hours before the scheduled event
              are eligible for a 50% refund of the total booking fee. To process
              your request, please notify us in writing via email, phone, or
              WhatsApp.
            </p>

            <p>
              Unfortunately, no-shows or late arrivals will result in the full
              experience fee being charged, as preparations and reservations
              will already have been made.
            </p>

            <p>
              If you need to reschedule your experience, we are happy to assist.
              Rescheduling requests must be communicated in writing through
              email, phone, or WhatsApp at least 48 hours before the scheduled
              event date. Please note that rescheduling is subject to
              availability.
            </p>

            <p>
              Kindly note that tickets are non-transferable and cannot be
              reassigned or used by another person.
            </p>

            <p>
              We encourage you to reach out as early as possible if your plans
              change. This helps us serve you better and maintain the quality of
      ...
      <div className="relative z-10">
        <ServiceCategories
          ...
          items={restaurantData.items.slice(0, 4).map((i) => ({
            title: i.name,
            image: i.image,
