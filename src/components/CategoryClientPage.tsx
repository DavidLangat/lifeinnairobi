...
export default function CategoryClientPage({ item, relatedItems, basePath, categoryName }: CategoryClientPageProps) {
  return (
                ...
                >
                    ...
                    <div className="prose prose-lg max-w-none text-gray-600 font-open-sans">
                        ...
                        <div className="mt-12 pt-8 border-t border-gray-100 flex flex-wrap gap-4 not-prose">
                            <a
                                href={`https://wa.me/254740726783?text=Hello%2C%20I%20would%20like%20to%20make%20an%20inquiry%20or%20booking%20for%20${encodeURIComponent(item.name)}.`}
                                target="_blank"
